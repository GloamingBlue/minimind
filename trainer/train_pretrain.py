...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='pretrain_block', type=str, help="保存权重的前缀名")
    ...
    parser.add_argument('--max_seq_len', default=380, type=int, help="训练的最大截断长度（中文1token≈1.5~1.7字符）")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/minimind_dataset/pretrain_t2t.jsonl", help="预训练数据路径")
