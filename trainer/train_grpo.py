...
from trainer.trainer_utils import Logger, is_main_process, lm_checkpoint, init_distributed_mode, setup_seed, SkipBatchSampler, init_model, LMForRewardModel, package_model_weights
...
def grpo_train_epoch(epoch, loader, iters, rollout_engine, ref_model, reward_model, start_step=0, wandb=None, use_sglang=False):
    for step, batch in enumerate(loader, start=start_step + 1):
        ...
        if (step % args.save_interval == 0 or step == iters) and is_main_process():
            ...
            torch.save(package_model_weights(state_dict, lm_config), ckp)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_weight', default='cispo_block', type=str, help="保存权重的前缀名")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/minimind_dataset/rlaif.jsonl", help="RLAIF数据路径")
    ...
    parser.add_argument('--from_weight', default='dpo_block', type=str, help="基于哪个权重训练")
