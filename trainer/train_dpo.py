...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="dataset/minimind_dataset/dpo.jsonl", help="DPO训练数据路径")
    parser.add_argument('--from_weight', default='full_sft_kd', type=str, help="基于哪个权重训练")
